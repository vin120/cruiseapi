...
class MemberService {
	...
	public static function getCrewinfobysign($sign)
	{
		$sql  =' SELECT crew_id as member_id,crew_code as code,cn_name as name,smart_card_number, passport_number, crew_password as member_password ,
